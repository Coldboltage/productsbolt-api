...
export class CandidatePageCacheController {
  constructor(private readonly candidatePageCacheService: CandidatePageCacheService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateCandidatePageCacheDto: UpdateCandidatePageCacheDto) {
    return this.candidatePageCacheService.update(+id, updateCandidatePageCacheDto);
  }
